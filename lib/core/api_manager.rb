...
class ApiManager
  ...
  SDK_VERSION = IBMAppConfiguration::VERSION
  ...
  class << self
    ...
    def token
      ...
      begin
        ...
        if authorization.nil?
          raise StandardError, "Authentication succeeded but no Authorization header was set. Request: #{request.inspect}"
        end
    ...
    #
    def post_metering(url, metering_data, apikey)
      require 'json'
