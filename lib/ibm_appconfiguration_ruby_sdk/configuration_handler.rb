...
module IbmAppconfigurationRubySdk
  ...
  class ConfigurationHandler
    ...
    def self.current_instance
      raise IbmAppconfigurationRubySdk::ConfigurationError.new(Constants::SINGLETON_EXCEPTION) \
    ...
    def track(_event_key, _entity_id)
      raise NotImplementedError.new("track is not yet implemented — requires MetricEvents port from Node SDK")
    end
