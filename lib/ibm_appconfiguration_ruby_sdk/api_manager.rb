  ...
  class << self
    ...
    def set_authenticator
      ...
      begin
        ...
        raise IbmAppconfigurationRubySdk::ConfigurationError,
              "Failed to initialise IAM authenticator: #{e.message}"
      end
    end
    ...
    def base_service_client
      if @base_service_client.nil?
        raise IbmAppconfigurationRubySdk::ConfigurationError, "Authenticator not set. Call set_authenticator first." if @iam_authenticator.nil?
    ...
    def token
      ...
      raise IbmAppconfigurationRubySdk::ConfigurationError, "Authentication succeeded but no Authorization header was set. Request: #{request.inspect}" if authorization.nil?
